/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: e093be0ce3c934e8b6a82153d1392763)
...
interface __BaseEnv_CloudflareEnv {
	...
	RANK_TRACKING_PROVIDER: string;
	RANK_BROWSER_EXECUTABLE_PATH: string;
	RANK_BROWSER_HEADLESS: string;
	WORKER_SELF_REFERENCE: Fetcher /* ushikuns-ai */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_ANON_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "GEMINI_API_KEY" | "GEMINI_MODEL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_REDIRECT_URI" | "RANK_TRACKING_PROVIDER" | "RANK_BROWSER_EXECUTABLE_PATH" | "RANK_BROWSER_HEADLESS">> {}
}
